                        ...
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const toolLabel = (() => {
                              ...
                              if (tool.toolName === "str_replace_editor" && args && fileName) {
                                if (args.command === "create") return `Creating ${fileName}`;
                                if (args.command === "str_replace" || args.command === "insert") return `Updating ${fileName}`;
                                if (args.command === "view") return `Reading ${fileName}`;
                              }
                              if (tool.toolName === "file_manager" && args && fileName) {
                                if (args.command === "delete") return `Deleting ${fileName}`;
                                if (args.command === "rename") return `Renaming ${fileName}`;
                              }
                              return fileName ? `Updating ${fileName}` : tool.toolName;
                            })();
                            return (
